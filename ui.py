...
class POSE_PT_juar_autoref_Limbs(bpy.types.Panel):
	bl_label = "Limbs"
...
class POSE_PT_juar_LiveAutoRef(bpy.types.Panel):
	bl_label = "Live AutoRef"
	bl_space_type = 'VIEW_3D'
	bl_region_type = 'TOOLS'
	bl_category = "AutoRef"				
...
def register():
	...
	bpy.utils.register_class(POSE_PT_juar_autoref_Limbs)
	bpy.utils.register_class(POSE_PT_juar_LimbDetail)
	bpy.utils.register_class(POSE_PT_juar_LiveAutoRef)
	
def unregister():
	bpy.utils.unregister_class(POSE_UL_juar_LimbList)
	bpy.utils.unregister_class(POSE_UL_juar_BoneList)
	
	bpy.utils.unregister_class(POSE_PT_juar_autoref_Limbs)
	bpy.utils.unregister_class(POSE_PT_juar_LimbDetail)
	bpy.utils.unregister_class(POSE_PT_juar_LiveAutoRef)